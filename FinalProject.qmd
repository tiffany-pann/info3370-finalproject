...
Our unit of analysis is an individual. We are using the IPUMs Higher Education dataset, which contains survey information gathered from survey participants who have at least a bachelors degree.
...
Prior to any sort of graphing, as we were looking through the data-set, we noticed quite a few values that looked out of place. We first filtered out
