...
Our unit of analysis is a individual. We are using the IPUMs Higher Education dataset, which contains survey information gathered from survey participants who have at least a bachelors degree.
...
We sourced our data from the IPUMs higher education database. (NEED TO ADD TO THIS SECTION)
...
### Job Satisfaction Across Different Majors:
